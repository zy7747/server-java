...
public class RoleController {
    ...
    @Log(title = "角色新增/修改", module = "配置中心", content = "角色新增/修改", type = OperateType.INSERT)
    ...
    @Log(title = "角色删除", module = "配置中心", content = "角色删除", type = OperateType.DELETE)
    ...
    public void roleExport(HttpServletResponse response) throws IOException {
        ExcelUtils.export(response, "角色.xlsx", "角色", RoleExportVO.class, RoleConvert.INSTANCE.export(roleMapper.selectList(new QueryWrapper<>())));
    }
}